...
#     return traces - np.average(traces)
...
if __name__ == "__main__":
    ...
    x_train = normalization(remove_avg(poi)) #normalization(remove_avg(leakages)) #normalization(leakages)  # Normalization is used for improving the learning
    ...
    profile_engine.train(x_train=x_train, metadata=metadata, epochs=100, batch_size=128, validation_split=0.02)  #400, 50
